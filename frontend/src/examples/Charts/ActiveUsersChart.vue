...
<template>
  <div class="card">
    <div class="card-body p-3">
      ...
      <h6 class="mt-4 mb-0 me-2">Người dùng hoạt động</h6>
      <p class="text-sm me-2">
        (
        <span class="font-weight-bolder">+23%</span>) so với tuần trước
      </p>
        ...
        <div class="row">
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 text-xs font-weight-bold">Người dùng</p>
            </div>
          ...
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 text-xs font-weight-bold">Lượt nhấp</p>
            </div>
          ...
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 text-xs font-weight-bold">Doanh số</p>
            </div>
          ...
          <div class="py-3 col-3 ps-0">
            <div class="mb-2 d-flex">
              ...
              <p class="mt-1 mb-0 text-xs font-weight-bold">Mục</p>
            </div>
